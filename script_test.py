...
if __name__ == "__main__":
    ...
    if a == 0:
        ...
        logger.warning(f"Build Exception: {a}")
        print(f"Build Exception: {a}")
    elif a == 2:
        logger.warning(f"Update Exception: {a}")
        print(f"Update Exception: {a}")
    else:
        logger.warning(f"Other Exception: {a}")
        print(f"Other Exception: {a}")
